...
my $gA='SFRUCORN70000026001';
my $WD='/home/knam/work/sfrugi_SenegalHostPlant/P450';
...
my $gffD="$WD/annot/gff";
my $vcfD="$WD/vcf";
my $refF="$WD/annot/sfC.ver7.fa";
my $outD="/home/knam/work/sfrugi_SenegalHostPlant/P450/SFRUCORN70000026001_alter";
